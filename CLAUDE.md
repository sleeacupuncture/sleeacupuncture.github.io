...
Static single-page website for Dr. Lee's Acupuncture Clinic (`sleeacupuncture.com`), deployed to GitHub Pages. Vanilla HTML5/CSS3/JS — no framework, no build step, no package manager.
