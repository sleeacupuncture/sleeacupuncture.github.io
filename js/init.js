...
$(function () {
      ...
      $('.parallax').each(function () {
        ...
        if ((bottom > $(window).scrollTop()) && (top < scrollTop)) {
          ...
          if (isHome) {
            ...
            $('#home .logo, #home .welcome, #home .call-to-action, #home .macbook-preview')
            .css('opacity', percent);
          }
  ...
  $('form .form-control').blur(function () {
    $(this).siblings('label').first().children('i').first()
  ...
  function initialize() {
    var myLatLong = new google.maps.LatLng(40.761315, -73.763671);
    var mapOptions = {
      center: myLatLong,
      scrollwheel: false,
      zoom: 16,
    ...
    var marker = new google.maps.Marker({
        position: myLatLong,
        map: map,
        title: "Dr. Lee's Acupuncture Clinic",
      });
